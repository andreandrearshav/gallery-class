...
export default function Gallery({ TahunList, fotoMap }) {
  ...
  return (
    <main
      ...
      <div className="mb-10">
        <h1
          className={`${syne.className} text-5xl md:text-7xl font-black uppercase text-white mb-2`}>
          Halaman Gallery
        </h1>
      ...
      {preview && (
        <div
          className="fixed inset-0 z-10 bg-black/70 flex justify-center items-center p-4"
